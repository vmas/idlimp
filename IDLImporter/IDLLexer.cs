	...
	public 	class IDLLexer : antlr.CharScanner	, TokenStream
	 {
		...
		private void initialize()
		{
			...
			literals.Add("size_is", 163);
			literals.Add("optional", 157);
			literals.Add("proxy", 28);
			literals.Add("last_is", 167);
			literals.Add("nsid", 66);
			literals.Add("byte", 112);
			literals.Add("public", 105);
			literals.Add("represent_as", 103);
			literals.Add("case", 130);
			literals.Add("message", 52);
			literals.Add("short", 119);
			literals.Add("uidefault", 145);
			literals.Add("raises", 151);
			literals.Add("defaultbind", 35);
			literals.Add("object", 23);
			literals.Add("ignore", 140);
			literals.Add("readonly", 75);
			literals.Add("lcid", 50);
			literals.Add("propputref", 144);
			literals.Add("octet", 109);
			literals.Add("wire_marshal", 102);
			literals.Add("implicit_jscontext", 149);
			literals.Add("shared", 162);
			literals.Add("licensed", 51);
			literals.Add("module", 10);
			literals.Add("unsigned", 108);
			literals.Add("const", 79);
			literals.Add("float", 124);
			literals.Add("context_handle", 98);
			literals.Add("context", 170);
			literals.Add("length_is", 165);
			literals.Add("inout", 154);
			literals.Add("source", 169);
			literals.Add("retval", 155);
			literals.Add("defaultvalue", 156);
			literals.Add("ptr", 59);
			literals.Add("appobject", 30);
			literals.Add("first_is", 166);
			literals.Add("optional_argc", 148);
			literals.Add("noncreatable", 54);
			literals.Add("control", 32);
			literals.Add("handle", 99);
			literals.Add("Null", 65);
			literals.Add("optimize", 27);
			literals.Add("importlib", 72);
			literals.Add("small", 118);
			literals.Add("binaryname", 150);
			literals.Add("ref", 58);
			literals.Add("handle_t", 114);
			literals.Add("cstring", 69);
			literals.Add("cpp_quote", 178);
			literals.Add("notxpcom", 141);
			literals.Add("custom", 33);
			literals.Add("range", 160);
			literals.Add("function", 60);
			literals.Add("out", 153);
			literals.Add("callback", 138);
			literals.Add("library", 15);
			literals.Add("displaybind", 38);
			literals.Add("native", 97);
			literals.Add("iid_is", 159);
			literals.Add("hyper", 122);
			literals.Add("L", 173);
			literals.Add("deprecated", 62);
			literals.Add("entry", 41);
			literals.Add("FALSE", 94);
			literals.Add("usesgetlasterror", 146);
			literals.Add("oleautomation", 56);
			literals.Add("jsval", 71);
			literals.Add("propput", 143);
			literals.Add("version", 18);
			literals.Add("typedef", 96);
			literals.Add("nonbrowsable", 53);
			literals.Add("interface", 73);
			literals.Add("sequence", 132);
			literals.Add("uuid", 17);
			literals.Add("array", 161);
			literals.Add("switch_type", 106);
			literals.Add("pointer_default", 24);
			literals.Add("broadcast", 139);
			literals.Add("immediatebind", 49);
			literals.Add("coclass", 16);
			literals.Add("aggregatable", 29);
			literals.Add("midl_pragma_warning", 179);
			literals.Add("dispinterface", 74);
			literals.Add("any", 110);
			literals.Add("double", 125);
			literals.Add("SAFEARRAY", 171);
			literals.Add("utf8string", 68);
			literals.Add("nonextensible", 55);
			literals.Add("noscript", 64);
			literals.Add("Undefined", 63);
			literals.Add("union", 128);
			literals.Add("__int3264", 5);
			literals.Add("enum", 131);
			literals.Add("pipe", 100);
			literals.Add("propget", 142);
			literals.Add("int", 121);
			literals.Add("exception", 137);
			literals.Add("switch_is", 168);
			literals.Add("boolean", 126);
			literals.Add("max_is", 164);
			literals.Add("requestedit", 158);
			literals.Add("char", 123);
			literals.Add("astring", 70);
			literals.Add("defaultvtable", 37);
			literals.Add("string", 135);
