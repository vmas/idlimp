	...
	public 	class IDLLexer : antlr.CharScanner	, TokenStream
	 {
		...
		private void initialize()
		{
			...
			literals.Add("size_is", 165);
			literals.Add("optional", 159);
			literals.Add("proxy", 28);
			literals.Add("last_is", 169);
			literals.Add("nsid", 66);
			literals.Add("byte", 113);
			literals.Add("public", 106);
			literals.Add("represent_as", 104);
			literals.Add("case", 131);
			literals.Add("message", 52);
			literals.Add("short", 120);
			literals.Add("uidefault", 147);
			literals.Add("raises", 153);
			literals.Add("defaultbind", 35);
			literals.Add("object", 23);
			literals.Add("ignore", 141);
			literals.Add("readonly", 76);
			literals.Add("lcid", 50);
			literals.Add("propputref", 146);
			literals.Add("octet", 110);
			literals.Add("wire_marshal", 103);
			literals.Add("implicit_jscontext", 151);
			literals.Add("shared", 164);
			literals.Add("licensed", 51);
			literals.Add("module", 10);
			literals.Add("unsigned", 109);
			literals.Add("const", 80);
			literals.Add("float", 125);
			literals.Add("context_handle", 99);
			literals.Add("context", 172);
			literals.Add("length_is", 167);
			literals.Add("inout", 156);
			literals.Add("source", 171);
			literals.Add("retval", 157);
			literals.Add("defaultvalue", 158);
			literals.Add("ptr", 59);
			literals.Add("appobject", 30);
			literals.Add("first_is", 168);
			literals.Add("optional_argc", 150);
			literals.Add("noncreatable", 54);
			literals.Add("control", 32);
			literals.Add("handle", 100);
			literals.Add("Null", 65);
			literals.Add("optimize", 27);
			literals.Add("importlib", 73);
			literals.Add("small", 119);
			literals.Add("binaryname", 152);
			literals.Add("ref", 58);
			literals.Add("handle_t", 115);
			literals.Add("cstring", 69);
			literals.Add("cpp_quote", 180);
			literals.Add("notxpcom", 142);
			literals.Add("custom", 33);
			literals.Add("range", 162);
			literals.Add("function", 60);
			literals.Add("out", 155);
			literals.Add("callback", 139);
			literals.Add("library", 15);
			literals.Add("displaybind", 38);
			literals.Add("native", 98);
			literals.Add("iid_is", 161);
			literals.Add("hyper", 123);
			literals.Add("L", 175);
			literals.Add("deprecated", 62);
			literals.Add("entry", 41);
			literals.Add("FALSE", 95);
			literals.Add("usesgetlasterror", 148);
			literals.Add("oleautomation", 56);
			literals.Add("jsval", 71);
			literals.Add("propput", 145);
			literals.Add("version", 18);
			literals.Add("typedef", 97);
			literals.Add("nonbrowsable", 53);
			literals.Add("interface", 74);
			literals.Add("sequence", 133);
			literals.Add("uuid", 17);
			literals.Add("array", 163);
			literals.Add("switch_type", 107);
			literals.Add("pointer_default", 24);
			literals.Add("broadcast", 140);
			literals.Add("immediatebind", 49);
			literals.Add("coclass", 16);
			literals.Add("aggregatable", 29);
			literals.Add("midl_pragma_warning", 181);
			literals.Add("dispinterface", 75);
			literals.Add("any", 111);
			literals.Add("double", 126);
			literals.Add("SAFEARRAY", 173);
			literals.Add("utf8string", 68);
			literals.Add("nonextensible", 55);
			literals.Add("noscript", 64);
			literals.Add("Undefined", 63);
			literals.Add("union", 129);
			literals.Add("__int3264", 5);
			literals.Add("enum", 132);
			literals.Add("pipe", 101);
			literals.Add("propget", 144);
			literals.Add("int", 122);
			literals.Add("exception", 138);
			literals.Add("switch_is", 170);
			literals.Add("boolean", 127);
			literals.Add("max_is", 166);
			literals.Add("requestedit", 160);
			literals.Add("char", 124);
			literals.Add("astring", 70);
			literals.Add("defaultvtable", 37);
			literals.Add("string", 136);
	...
	public void mINT(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		{ // ( ... )+
			...
			for (;;)
			{
				...
				{
					if (_cnt351 >= 1) { goto _loop351_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
				}
