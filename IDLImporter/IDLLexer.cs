	...
	public 	class IDLLexer : antlr.CharScanner	, TokenStream
	 {
		...
		private void initialize()
		{
			...
			literals.Add("size_is", 155);
			literals.Add("optional", 150);
			literals.Add("proxy", 28);
			literals.Add("last_is", 159);
			...
			literals.Add("switch_is", 160);
			literals.Add("boolean", 119);
			literals.Add("max_is", 156);
