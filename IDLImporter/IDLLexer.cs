	...
	public 	class IDLLexer : antlr.CharScanner	, TokenStream
	 {
		...
		private void initialize()
		{
			...
			literals.Add("size_is", 153);
			literals.Add("optional", 148);
			literals.Add("proxy", 28);
			literals.Add("last_is", 157);
			literals.Add("byte", 104);
			literals.Add("public", 97);
			literals.Add("represent_as", 95);
			literals.Add("case", 122);
			literals.Add("message", 52);
			literals.Add("short", 111);
			literals.Add("uidefault", 138);
			literals.Add("raises", 142);
			literals.Add("defaultbind", 35);
			literals.Add("object", 23);
			literals.Add("ignore", 132);
			literals.Add("readonly", 67);
			literals.Add("lcid", 50);
			literals.Add("propputref", 137);
			literals.Add("octet", 101);
			literals.Add("wire_marshal", 94);
			literals.Add("licensed", 51);
			literals.Add("module", 10);
			literals.Add("unsigned", 100);
			literals.Add("const", 71);
			literals.Add("float", 116);
			literals.Add("context_handle", 90);
			literals.Add("context", 160);
			literals.Add("length_is", 155);
			literals.Add("inout", 145);
			literals.Add("source", 159);
			literals.Add("retval", 146);
			literals.Add("defaultvalue", 147);
			literals.Add("ptr", 59);
			literals.Add("appobject", 30);
			literals.Add("first_is", 156);
			literals.Add("optional_argc", 141);
			literals.Add("noncreatable", 54);
			literals.Add("control", 32);
			literals.Add("handle", 91);
			literals.Add("optimize", 27);
			literals.Add("importlib", 64);
			literals.Add("small", 110);
			literals.Add("ref", 58);
			literals.Add("handle_t", 106);
			literals.Add("cpp_quote", 168);
			literals.Add("notxpcom", 134);
			literals.Add("custom", 33);
			literals.Add("range", 151);
			literals.Add("function", 60);
			literals.Add("out", 144);
			literals.Add("callback", 130);
			literals.Add("library", 15);
			literals.Add("displaybind", 38);
			literals.Add("native", 89);
			literals.Add("iid_is", 150);
			literals.Add("hyper", 114);
			literals.Add("L", 163);
			literals.Add("deprecated", 62);
			literals.Add("entry", 41);
			literals.Add("FALSE", 86);
			literals.Add("usesgetlasterror", 139);
			literals.Add("oleautomation", 56);
			literals.Add("propput", 136);
			literals.Add("version", 18);
			literals.Add("typedef", 88);
			literals.Add("nonbrowsable", 53);
			literals.Add("interface", 65);
			literals.Add("sequence", 124);
			literals.Add("uuid", 17);
			literals.Add("array", 152);
			literals.Add("switch_type", 98);
			literals.Add("pointer_default", 24);
			literals.Add("broadcast", 131);
			literals.Add("immediatebind", 49);
			literals.Add("coclass", 16);
			literals.Add("aggregatable", 29);
			literals.Add("midl_pragma_warning", 169);
			literals.Add("dispinterface", 66);
			literals.Add("any", 102);
			literals.Add("double", 117);
			literals.Add("SAFEARRAY", 161);
			literals.Add("nonextensible", 55);
			literals.Add("noscript", 133);
			literals.Add("Undefined", 63);
			literals.Add("union", 120);
			literals.Add("__int3264", 5);
			literals.Add("enum", 123);
			literals.Add("pipe", 92);
			literals.Add("propget", 135);
			literals.Add("int", 113);
			literals.Add("exception", 129);
			literals.Add("switch_is", 158);
			literals.Add("boolean", 118);
			literals.Add("max_is", 154);
			literals.Add("requestedit", 149);
			literals.Add("char", 115);
			literals.Add("defaultvtable", 37);
			literals.Add("string", 127);
			literals.Add("default", 34);
			literals.Add("odl", 26);
			literals.Add("id", 47);
			literals.Add("dual", 40);
			literals.Add("helpstringdll", 45);
			literals.Add("false", 87);
			literals.Add("user_marshal", 96);
			literals.Add("restricted", 57);
			literals.Add("helpfile", 43);
			literals.Add("bindable", 31);
			literals.Add("dllname", 39);
			literals.Add("attribute", 68);
			literals.Add("v1_enum", 4);
			literals.Add("async_uuid", 21);
			literals.Add("struct", 119);
			literals.Add("__int64", 6);
			literals.Add("helpcontext", 42);
			literals.Add("signed", 99);
			literals.Add("import", 13);
			literals.Add("endpoint", 25);
			literals.Add("in", 143);
			literals.Add("TRUE", 84);
			literals.Add("void", 103);
			literals.Add("wchar_t", 105);
			literals.Add("transmit_as", 93);
			literals.Add("switch", 121);
			literals.Add("defaultcollelem", 36);
			literals.Add("helpstring", 44);
			literals.Add("true", 85);
			literals.Add("long", 112);
			literals.Add("hidden", 46);
			literals.Add("scriptable", 61);
			literals.Add("unique", 109);
			literals.Add("idempotent", 48);
			literals.Add("vararg", 140);
		}
	...
	public void mINT(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		{ // ( ... )+
			...
			for (;;)
			{
				...
				{
					if (_cnt338 >= 1) { goto _loop338_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
				}
			...
			if ((cached_LA1=='E'||cached_LA1=='e'))
			{
				...
				{ // ( ... )+
					...
					for (;;)
					{
						...
						{
							if (_cnt346 >= 1) { goto _loop346_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
						}
