	...
	public 	class IDLLexer : antlr.CharScanner	, TokenStream
	 {
		...
		private void initialize()
		{
			...
			literals.Add("byte", 105);
			literals.Add("public", 98);
			literals.Add("represent_as", 96);
			literals.Add("case", 123);
			literals.Add("message", 52);
			literals.Add("short", 112);
			literals.Add("uidefault", 138);
			literals.Add("raises", 142);
			literals.Add("defaultbind", 35);
			literals.Add("object", 23);
			literals.Add("ignore", 133);
			literals.Add("readonly", 68);
			literals.Add("lcid", 50);
			literals.Add("propputref", 137);
			literals.Add("octet", 102);
			literals.Add("wire_marshal", 95);
			literals.Add("licensed", 51);
			literals.Add("module", 10);
			literals.Add("unsigned", 101);
			literals.Add("const", 72);
			literals.Add("float", 117);
			literals.Add("context_handle", 91);
			...
			literals.Add("handle", 92);
			literals.Add("optimize", 27);
			literals.Add("importlib", 65);
			literals.Add("small", 111);
			literals.Add("ref", 58);
			literals.Add("handle_t", 107);
