	...
	public 	class IDLLexer : antlr.CharScanner	, TokenStream
	 {
		...
		private void initialize()
		{
			...
			literals.Add("size_is", 154);
			literals.Add("optional", 149);
			literals.Add("proxy", 28);
			literals.Add("last_is", 158);
			...
			literals.Add("implicit_jscontext", 142);
			...
			literals.Add("context", 161);
			literals.Add("length_is", 156);
			literals.Add("inout", 146);
			literals.Add("source", 160);
			literals.Add("retval", 147);
			literals.Add("defaultvalue", 148);
			literals.Add("ptr", 59);
			literals.Add("appobject", 30);
			literals.Add("first_is", 157);
			...
			literals.Add("switch_is", 159);
			literals.Add("boolean", 119);
			literals.Add("max_is", 155);
			literals.Add("requestedit", 150);
			...
			if ((cached_LA1=='E'||cached_LA1=='e'))
			{
				...
				{ // ( ... )+
					...
					for (;;)
					{
						...
						{
							if (_cnt348 >= 1) { goto _loop348_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
						}
