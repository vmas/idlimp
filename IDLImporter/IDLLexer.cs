	...
	public 	class IDLLexer : antlr.CharScanner	, TokenStream
	 {
		...
		private void initialize()
		{
			...
			literals.Add("inout", 147);
			literals.Add("source", 162);
			literals.Add("retval", 148);
			literals.Add("defaultvalue", 149);
			literals.Add("ptr", 59);
